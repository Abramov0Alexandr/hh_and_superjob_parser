...
class HeadHunterAPI:
    ...
    def __get_request(self, search_vacancy, page):
    ...
    def start_parse(self, keyword, pages=10):
        current_page = 0
        ...
        print(f"Парсинг окончен, собрано {len(self.__vacancies_list)} вакансий с {current_page} страниц\n"
              ...
              f"Чтобы увидеть и использовать собранную информацию, воспользуйтесь методом 'get_vacancies_list'")
